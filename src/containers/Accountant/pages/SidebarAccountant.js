...
class SidebarAccountant extends Component {
  state = {
    menu: false,
    burger: false,
  };
          ...
          <div className="dashboardBlock">
            <div className="sidebarFixed">
              <div className="sidebar">
                ...
                <NavLink onClick={this.handleclose} to="/accountant-ticket">
                  Абитуриенты
                </NavLink>
                <NavLink onClick={this.handleclose} to="/accountant-analytics">
                  Отдел Аналитики
                </NavLink>
