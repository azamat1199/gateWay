...
import SideOtdel from '../SideOtdel';
...
// import icon
import search_icon from '../../../../assets/icon/Search2.svg';
...
const datablock6 = require('../../json/block6.json');
        ...
        <div className="sideOtdel">
          ...
          <div className="block_0">
            <div className="settSearch">
              ...
              <button className="settingsUniver">
                <img src={settings} alt="" />
              </button>
            </div>
          </div>
          <h4 id="block_h4">Отдел Бухгалтерии</h4>
          {/* end block - 0 */}
          ...
          <div className="block_3">
                  ...
                  <PieChart width={188} height={188}>
                    ...
                    >
                      {data.map((entry, index) => (
                        <Cell
                          key={`cell-${index}`}
                          fill={COLORSPie[index % COLORS.length]}
                        />
                      ))}
                    </Pie>
                    <Tooltip />
            ...
            {/* PieChart */}
            <div className="block_3_1">
              <h4>Языки обучения университетов</h4>
              <div className="pieChart">
                <div>
                  <span>500</span>
                  <PieChart width={188} height={188}>
                ...
                <div className="PieChartSurf">
                  ...
                  <span>
                    <div style={{ background: '#C6E4FB' }}></div>
                    <h5>Узбекский</h5>
                    <h6>700</h6>
                  </span>
                </div>
