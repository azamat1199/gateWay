        ...
        <div className="dashboardBlock">
          <div className="sidebarFixed">
            <div className="sidebar">
              ...
              <NavLink to="/maneger/home">
                Клиентский ввод
              </NavLink>
              <NavLink onClick={handleclose} to="/maneger/status">
                Статус клиента
              </NavLink>
              <NavLink onClick={handleclose} to="/maneger/priceList">
                Прайс лист
              </NavLink>
              <NavLink onClick={handleclose} to="/maneger/Analysis">
                Отдел аналитики
              </NavLink>
              <NavLink onClick={handleclose} to="/maneger/news">
                Новости
              </NavLink>

              <div className="vector"></div>
              <div className={menu ? 'div_active div_a' : 'div_a'}>
                <div className={menu ? 'link_active maneger' : 'maneger'}>
