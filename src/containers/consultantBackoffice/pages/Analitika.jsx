...
const SideOtdel = () => {
  ...
  const fetchNumber = async () => {
    ...
    try {
      const res = await Axios.get(
        "/company/director/statistics/accountant/third_block/"
      );
  ...
  const fetchByDay = async () => {
    ...
    try {
      const res = await Axios.get(
        `/company/director/statistics/accountant/third_block/?day=true`
      );
      const { status, data } = res;
      if (status === 200) {
        const { payment } = data;
  ...
  const fetchByWeek = async () => {
    ...
    try {
      const res = await Axios.get(
        `/company/director/statistics/accountant/third_block/?week=true`
      );
      const { status, data } = res;
      if (status === 200) {
        const { payment } = data;
  ...
  const fetchByMonth = async () => {
    ...
    try {
      const res = await Axios.get(
        `/company/director/statistics/accountant/third_block/?month=true`
      );
      const { status, data } = res;
      if (status === 200) {
        const { payment } = data;
  ...
  const fetchByYear = async () => {
    ...
    try {
      const res = await Axios.get(
        `/company/director/statistics/accountant/third_block/?year=true`
      );
      const { status, data } = res;
      if (status === 200) {
        const { payment } = data;
  ...
  const fetchByChoosenDate = async () => {
    ...
    try {
      const res = await Axios.get(
        `/company/director/statistics/accountant/third_block/?date-from=${startDate.toLocaleDateString()}&date-to=${endDate.toLocaleDateString()}`
      );
      const { status, data } = res;
      if (status === 200) {
        const { payment } = data;
  ...
  const fetchSecondBlock = async () => {
    ...
    try {
      const res = await Axios.get(
        "/company/director/statistics/accountant/second_block/"
      );
      const { status, data } = res;
      if (status === 200) {
        setSecond(data);
      ...
      <Sidebar>
        <div className="asos" id="top">
          ...
          <div className="sideOtdel">
            ...
            {/* block - 1 */}
            <div style={{ marginTop: 20, marginBottom: 0 }} className="block_1">
              {/* card */}
