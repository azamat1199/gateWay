                    ...
                    <div className="doc_perevodi">
                        ...
                        <div className="doc_1">
                            ...
                            <label htmlFor="drop2" className="form_down">
                              <img src={folder} alt="" />
                              <input ref={inputEl1} type="file" name="passport_confirmed" id="drop2" />
                            ...
                            <label htmlFor="drop1" className="form_down">
                                <img src={folder} alt="" />
                                <input ref={inputEl2} type="file" name="diploma_confirmed" id="drop1" />
                                <p>Drop your files here or <span>choose file</span></p>
                           </label>:''
                            }
                           {
                               ...
                               <label htmlFor="drop3" className="form_down">
                                    <img src={folder} alt="" />
                                    <input ref={inputEl3} type="file" name="birth_cert_confirmed" id="drop3" />
                                    <p>Drop your files here or <span>choose file</span></p>
                              </label>:''
                           }
                           {
                               ...
                               <label htmlFor="drop4" className="form_down">
                                    <img src={folder} alt="" />
                                    <input ref={inputEl4} type="file" name="photo_confirmed" id="drop4" />
                                    <p>Drop your files here or <span>choose file</span></p>
                              </label>:''
                           }
                           {
                               ...
                               <label htmlFor="drop5" className="form_down">
                                    <img src={folder} alt="" />
                                    <input ref={inputEl5} type="file" name="passport_mother_confirmed" id="drop5" />
                                    <p>Drop your files here or <span>choose file</span></p>
                               </label>:''
                           }
                           {
                               ...
                               <img src={folder} alt="" />
                                    <input ref={inputEl6} type="file" name="marriage_cert_confirmed" id="drop6" />
                                    <p>Drop your files here or <span>choose file</span></p>
                               </label>:''
                           }
                            {
                                ...
                                <img src={folder} alt="" />
                                    <input ref={inputEl7} type="file" name="med_063_cert_confirmed" id="drop7" />
                                    <p>Drop your files here or <span>choose file</span></p>
                                </label>:''
                            }
                            {
                                ...
                                <label htmlFor="drop8" className="form_down">
                                    <img src={folder} alt="" />
                                    <input ref={inputEl8} type="file" name="med_086_cert_confirmed" id="drop8" />
                                    <p>Drop your files here or <span>choose file</span></p>
                               </label>:''
                            }
                            {
                                ...
                                <label htmlFor="drop9" className="form_down">
                                    <img src={folder} alt="" />
                                    <input  ref={inputEl9} type="file" name="hiv_cert_confirmed" id="drop9" />
                                    <p>Drop your files here or <span>choose file</span></p>
                                </label>:''
                            }
                        </div>
