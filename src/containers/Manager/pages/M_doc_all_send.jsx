...
const M_doc_all_send = () => {
  ...
  // const newFileOAndN = (e) => {
  //   const value = e.target.value;
  //   if ("o" == value) {
  //     setIsNeedTranslate("original_confirmed");
  //
  //   } else {
  //     setIsNeedTranslate("need_to_translate");
  //
  //   }
  // };
  ...
  const addNewFile = async (e) => {
    ...
    try {
      ...
      // formData.append(`${newFileName}_confirmed`, isNeedTranslate);
      // if ("original_confirmed" == isNeedTranslate) {
      //   setO((state) => ({ ...state, [`${newFileName}_O`]: true }));
      // } else {
      //   setN((state) => ({ ...state, [`${newFileName}_N`]: true }));
      // }
              ...
              <Fade in={open}>
                <div className="addNewUniverModalUniver talaba_modal">
                  ...
                  <div className="modalContainer">
                    ...
                    {/* <div>
                      <label> Перевод документов</label>
                      <select onChange={(e) => newFileOAndN(e)}>
                        <option value="n">Передать нотариусу</option>
                        <option value="o"> Потвердить оригинал</option>
                      </select>
                    </div> */}
