                      ...
                      <ButtonContainer>
                        {
                          myStep === 'payment_confirmation' ? 
                           ...
                           myStep === 'completed' || myStep === 'university' || myStep ==='электронный дагавор'|| currentStep === 'data_entry'  ? '':
                           <>
                            <button style={myStep === 'registered'   ? {}:{display:'none'}} onClick={()=> history.push('/universities')} > Найти университет </button>
                            <button style={ myStep === 'profile_filled' ? {}: {display:'none'}} onClick={()=> history.push('/payment-transaction')}> Заполнить анкету </button>
                           </>
                        }
                      </ButtonContainer>
